...
👤 ዕጣ የወጣለት ቤት የጽዳት ፈንዱን ለመሰብሰብ አካውንት ቁጥር ብቻ ያጋራል። ይህ ሃላፊነት በ4 ዓመት አንድ ጊዜ ብቻ ይደርሳል — ቀላል፣ አጭር እና ለሁሉም ጥቅም ያለው ነው! 😊
...
func (b *Bot) remindDelegateAccount() {
	...
	b.sendToGroup(fmt.Sprintf(
		"⏰ *ቤት %s* እባክዎ አካውንትዎን ገና አልላኩም።\nይህንን ይጻፉ: `/account cbe 1234567890`\n\n"+
			"💡 አካውንት ቁጥር ብቻ ያጋሩ — ቀሪውን ታሆር ትሠራለች! ይህ ሃላፊነት በ4 ዓመት አንድ ጊዜ ብቻ ነው። 😊%s",
